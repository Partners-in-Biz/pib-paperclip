...
const manifest: PaperclipPluginManifestV1 = {
  ...
  jobs: [
    ...
    },
    {
      ...
      description: "Makes payslips that a locked run is still missing, links a pending Payroll Clerk hire and sends the setup checklist and Cockpit numbers (hourly).",
      schedule: "*/15 * * * *",
    },
  ],
  skills: SKILLS,
